...
namespace CSharp_ProgramingStudy.Chapter7_Extension
{
    ...
    /// 
    /// EventArgs 설명:
    /// EventArgs는 C#의 이벤트 모델에서 기본적으로 사용되는 클래스입니다. 
    /// 이벤트 핸들러에 전달할 추가적인 데이터가 없을 경우, EventArgs를 사용하여 이벤트 데이터를 전달할 수 있습니다. 
    /// 그러나 이벤트와 함께 추가적인 데이터를 전달해야 하는 경우, EventArgs를 상속받아 사용자 정의 이벤트 인수를 만들어 사용할 수 있습니다.
    /// </summary>
    public class Class6
    {
        /// <summary>
